        ...
        <div className="aboutMeContainer">
            ...
            <div className="title">About Me</div>
                <div className="bio">
                    ...
                    <br />
                    I work as a teaching assistant for the University of Washington Coding Boot Camp, which teaches HTML5, CSS3, JavaScript, jQuery, Express.js, React.js, Node.js, MySQL, and MongoDB. Currently, I am working on some MERN personal projects, including an app to plan and document trips to National Parks! In my coding work I enjoy using my problem-solving skills, creativity, adaptability, and curiosity. <br />
                    <br />
